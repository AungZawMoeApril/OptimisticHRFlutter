...
class _OnSiteDetailListWidgetState extends State<OnSiteDetailListWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnSiteDetailListModel());
              ...
              child: Container(
                ...
                height: () {
                  if ((_model.detailsValie == true) &&
                    ...
                    return 360.0;
                  } else if (_model.detailsValie == true) {
                    return 320.0;
                  } else if ('-' != widget.checkOut?.toString()) {
                    return 120.0;
                  } else {
                    return 180.0;
                  }
