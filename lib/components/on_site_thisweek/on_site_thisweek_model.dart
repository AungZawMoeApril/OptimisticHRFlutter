...
import 'on_site_thisweek_widget.dart' show OnSiteThisweekWidget;
...
class $1Model extends BaseViewModel {
  ...
  // Stores action output result for [Backend Call - API (GetTimeAttendanceListMobile)] action in onSiteThisweek widget.
