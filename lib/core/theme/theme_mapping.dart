...
const themeMapping = {
  ...
  'Theme.of(context).textTheme.displayMedium': 'Theme.of(context).textTheme.displayMedium',
  ...
  'Theme.of(context).textTheme.titleLarge': 'Theme.of(context).textTheme.titleLarge',
