...
class _CardTimeAttendanceWidgetState extends State<CardTimeAttendanceWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CardTimeAttendanceModel());
                                            ...
                                            child: Container(
                                              ...
                                              child: AppButton(
                                                ...
                                                text: valueOrDefault<String>(
                                                  widget.checkInAndOuttype
                                                      ?.toString(),
                                                  'Normal',
                                                ),
                                                style: ElevatedButton.styleFrom(
      minimumSize: Size(80.0, 18.0),
                                                  ...
                                                  color: () {
                                                    if ('Normal' ==
                                                        widget
                                                            .checkInAndOuttype
                                                            ?.toString()) {
                                                      return Color(0xFF00D57B);
                                                    } else if ('Late' ==
                                                        widget
                                                            .checkInAndOuttype
                                                            ?.toString()) {
                                                      return Color(0xFFF9A5A8);
                                                    } else if ('Absence' ==
                                                        widget
                                                            .checkInAndOuttype
                                                            ?.toString()) {
