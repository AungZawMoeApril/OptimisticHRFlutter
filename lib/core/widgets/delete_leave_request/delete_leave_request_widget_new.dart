...
class DeleteLeaveRequestWidgetViewModel extends BaseViewModel {
  
}

class DeleteLeaveRequestWidget extends StatelessWidget {
  const DeleteLeaveRequestWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return BaseView<DeleteLeaveRequestWidgetViewModel>(
      viewModelBuilder: () => DeleteLeaveRequestWidgetViewModel(),
