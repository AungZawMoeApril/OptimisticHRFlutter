...
class DeleteLeaveRequestDialogWidgetViewModel extends BaseViewModel {
  
}

class DeleteLeaveRequestDialogWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BaseView<DeleteLeaveRequestDialogWidgetViewModel>(
      viewModelBuilder: () => DeleteLeaveRequestDialogWidgetViewModel(),
