...
class DeleteOvertimeRequestWidgetViewModel extends BaseViewModel {
  
}

class DeleteOvertimeRequestWidget extends StatelessWidget {
  const DeleteOvertimeRequestWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return BaseView<DeleteOvertimeRequestWidgetViewModel>(
      viewModelBuilder: () => DeleteOvertimeRequestWidgetViewModel(),
