...
class LeaveAttachmentModelWidgetViewModel extends BaseViewModel {
  
}

class LeaveAttachmentModelWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BaseView<LeaveAttachmentModelWidgetViewModel>(
      viewModelBuilder: () => LeaveAttachmentModelWidgetViewModel(),
