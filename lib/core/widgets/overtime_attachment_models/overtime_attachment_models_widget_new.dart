...
class OvertimeAttachmentModelsWidgetViewModel extends BaseViewModel {
  
}

class OvertimeAttachmentModelsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BaseView<OvertimeAttachmentModelsWidgetViewModel>(
      viewModelBuilder: () => OvertimeAttachmentModelsWidgetViewModel(),
