...
import '/index.dart';
import 'check_out_over_all_widget.dart' show CheckOutOverAllWidget;
...
class $1Model extends BaseViewModel {
  ...
  // Stores action output result for [Backend Call - API (GetAllLocationsByCompanyID)] action in CheckOutOverAll widget.
  ApiCallResponse? apiResultLocation;
  // Stores action output result for [Backend Call - API (apiGetAddress)] action in CheckOutOverAll widget.
  ApiCallResponse? apiGetAddressCheckOut;
  // Stores action output result for [Backend Call - API (apiGetAddress)] action in CheckOutOverAll widget.
  ApiCallResponse? apiGetAddressResult;
  // Stores action output result for [Backend Call - API (GetDefaultSetting)] action in CheckOutOverAll widget.
  ApiCallResponse? apiGetDefaultSettingResult;
  bool isDataUploading_uploadDataQiw = false;
  FFUploadedFile uploadedLocalFile_uploadDataQiw =
      FFUploadedFile(bytes: Uint8List.fromList([]));

  // Stores action output result for [Backend Call - API (GetCheckInImageURL)] action in Container widget.
  ApiCallResponse? apiResult4m6;
  ...
  // Stores action output result for [Backend Call - API (UpdateClockInOutMobile)] action in Button widget.
  ApiCallResponse? apiResultUpdateClockInOut;
  // Stores action output result for [Backend Call - API (UpdateClockInOutMobile)] action in Button widget.
  ApiCallResponse? apiResultUpdateClockInOutOvertime;
