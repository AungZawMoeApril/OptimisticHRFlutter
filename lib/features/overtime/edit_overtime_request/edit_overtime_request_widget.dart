...
import 'edit_overtime_request_model.dart';
export 'edit_overtime_request_model.dart';

class EditOvertimeRequestWidget extends StatefulWidget {
  const EditOvertimeRequestWidget({
    super.key,
    required this.editOTRequest,
  });

  final dynamic editOTRequest;

  static String routeName = 'EditOvertimeRequest';
  static String routePath = '/editOvertimeRequest';

  @override
  State<EditOvertimeRequestWidget> createState() =>
      _EditOvertimeRequestWidgetState();
}

class _EditOvertimeRequestWidgetState extends State<EditOvertimeRequestWidget> {
  late EditOvertimeRequestModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditOvertimeRequestModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.startDate = functions.changeLeaveRequestedDateFormat(getJsonField(
        widget.editOTRequest,
        r'''$.start_Date''',
      ).toString().toString());
      _model.endDate = functions.changeLeaveRequestedDateFormat(getJsonField(
        widget.editOTRequest,
        r'''$.start_Date''',
      ).toString().toString());
      ...
      _model.attachmentModel = (getJsonField(
        widget.editOTRequest,
        r'''$.attachmentlist[:].attachment_file''',
        true,
      ) as List)
                  ...
                  children: [
                                    ...
                                    onTap: () async {
                                      ...
                                      if (selectedMedia != null &&
                                        ...
                                        try {
                                          ...
                                          _model.isDataUploading_uploadData4m1 =
                                              false;
                                        }
                                        if (selectedUploadedFiles.length ==
                                            selectedMedia.length) {
                                          safeSetState(() {
                                            _model.uploadedLocalFile_uploadData4m1 =
                                      ...
                                      if ((_model.uploadedLocalFile_uploadData4m1
                                                  .bytes?.isNotEmpty ??
                                              false)) {
                                        _model.apiResultGetCheckinImageURL =
                                            await GetCheckInImageURLCall.call(
                                          file: _model
                                              .uploadedLocalFile_uploadData4m1,
                                        );
                      ...
                      child: Builder(
                        builder: (context) {
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, imageItemListIndex) {
                              final imageItemListItem =
                                  imageItemList[imageItemListIndex];
                              return Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    10.0, 0.0, 10.0, 0.0),
                                child: Container(
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: AppButton(
                          onPressed: () async {
                            _model.apiDateOTRequest =
                                await MainGroup.updateOTRequestCall.call(
                              wholeDay: true,
                              oTRequestID: getJsonField(
                                widget.editOTRequest,
                                r'''$.oT_Request_ID''',
                              ),
                              startDate: _model.startDate,
                              endDate: _model.endDate,
                              oTStartTime: _model.startTime,
                              oTEndTime: _model.endTime,
                            ...
                            if ('0' ==
                                getJsonField(
                                  (_model.apiDateOTRequest?.jsonBody ?? ''),
                                  r'''$.status''',
                                ).toString()) {
                              await showDialog(
                                context: context,
