...
_$AttendanceRecordImpl _$$AttendanceRecordImplFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$AttendanceRecordImplToJson(_$AttendanceRecordImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
