...
// Extension to help with migrating from FlutterFlow
extension FFStateUtils on State {
...
class LeaveRequestWidget extends StatefulWidget {
  ...
  static String routeName = 'LeaveRequest';
  static String routePath = '/leaveRequest';
                                        ...
                                        child: FutureBuilder<ApiCallResponse>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            return FlutterFlowDropDown<int>(
                                              ...
                                              options: List<int>.from(MainGroup
                                                  .getLeaveWithRemainingDaysCall
                                                  .timeOffIDList(
                                                ddlLeaveTypeGetLeaveWithRemainingDaysResponse
                                                    .jsonBody,
                                              )!),
                                              optionLabels: MainGroup
                                                  .getLeaveWithRemainingDaysCall
                                                  .leaveMenuList(
                                                ddlLeaveTypeGetLeaveWithRemainingDaysResponse
                                                    .jsonBody,
                                    ...
                                    children: [
                                      Expanded(
                                        child: Material(
                                          ...
                                          child: Container(
                                            width: _model
                                                    .isDataUploading_uploadDataleave
                                                ? double.infinity
                                                : 100.0,
                                            height: 60.0,
                                            decoration: BoxDecoration(
                                              ...
                                              onTap: () async {
                                                ...
                                                if (selectedMedia != null &&
                                                  ...
                                                  try {
                                                    ...
                                                    _model.isDataUploading_uploadDataleave =
                                                        false;
                                                  }
                                                  if (selectedUploadedFiles
                                                    ...
                                                    safeSetState(() {
                                                      _model.uploadedLocalFile_uploadDataleave =
                                                          selectedUploadedFiles
                                                              .first;
                                                    });
                                                  } else {
                                                ...
                                                if ((_model.uploadedLocalFile_uploadDataleave
                                                            .bytes?.isNotEmpty ??
                                                        false)) {
                                                  _model.apiResultGetCheckinImageURL =
                                                      await GetCheckInImageURLCall
                                                          .call(
                                                    file: _model
                                                        .uploadedLocalFile_uploadDataleave,
                                                  );
                            ...
                            Padding(
                              ...
                              child: AppButton(
                                onPressed: (_model.availableDay == 0)
                                    ...
                                    : () async {
                                        if (_model.isAllDay) {
                                          _model.apiResultAddTimeOffRequestForEMPWholeDay =
                                              await MainGroup
                                                  .addTimeOffRequestForEMPWholeDayCall
                                                  .call(
                                            approverID: AppState().reportID,
                                            balance: _model.balance?.toString(),
                                            startDate: valueOrDefault<String>(
                                              functions
                                                  .changeDateFormatYearMonthDay(
                                                      _model.datePicked1!),
                                              'start date',
                                            ),
                                            endDate: functions
                                            ...
                                            message: _model
                                                ...
                                                .text,
                                            saveDraft: false,
                                            timeoffID: _model.ddlLeaveTypeValue,
                                            wholeDay: true,
                                          ...
                                          if ((_model.apiResultAddTimeOffRequestForEMPWholeDay
                                                      ?.statusCode ??
                                                  200) ==
                                              200) {
                                            await showDialog(
                                            ...
                                            _model.getworkFlowOfOTRequestAPI =
                                                await MainGroup
                                            ...
                                            if ((_model
                                              ...
                                              safeSetState(() {});
                                              _model.addNotificationInfoMobResult =
                                                  await MainGroup
                                          ...
                                          _model.apiResultAddTimeOffRequestForEMPHalfDay =
                                              await MainGroup
                                                  .addTimeOffRequestForEMPHalfDayCall
                                                  .call(
                                            approverID: AppState().reportID,
                                            balance: _model.balance?.toString(),
                                            requestedDate: functions
                                                .changeDateFormatYearMonthDay(
                                                    _model.datePicked3!),
                                          ...
                                          if ((_model.apiResultAddTimeOffRequestForEMPHalfDay
                                                      ?.statusCode ??
                                                  200) ==
                                              200) {
                                            await showDialog(
