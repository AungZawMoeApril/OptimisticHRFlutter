...
class OvertimeNewPageModel extends BaseViewModel {
  ...
  void removeAtIndexFromCurrentOTList(int index) => currentOTList.removeAt(index);
  void insertAtIndexInCurrentOTList(int index, dynamic item) => currentOTList.insert(index, item);
