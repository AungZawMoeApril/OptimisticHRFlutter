...
import 'package:hr_optimistic/core/theme/app_theme.dart';
...
import 'package:hr_optimistic/core/widgets/app_widgets.dart';
import 'package:hr_optimistic/backend/api_requests/api_calls.dart';
import 'package:hr_optimistic/core/widgets/app_icon_button.dart';
import 'package:hr_optimistic/core/utils/app_utils.dart';
import 'package:hr_optimistic/core/widgets/app_button.dart';
import 'package:hr_optimistic/core/utils/form_field_controller.dart';
import 'package:hr_optimistic/core/utils/upload_data.dart';
import 'package:hr_optimistic/core/utils/custom_functions.dart' as functions;
import 'package:hr_optimistic/index.dart';
                            ...
                            onPressed: ((_model.datePicked1 == null) ||
                                ...
                                : () async {
                                    _model.apiResultuOT =
                                      ...
                                      saveDraft: false,
                                      requesterID: AppState().employeeID,
                                      approverID: AppState().reportID,
                                      approverID2: AppState().approverID2 == 0
                                          ? null
                                          : AppState().approverID2,
                                      approverID3: AppState().approverID3 == 0
                                          ? null
                                          : AppState().approverID3,
                                      approverID4: AppState().approverID4 == 0
                                          ? null
                                          : AppState().approverID4,
                                      approverID5: AppState().approverID5 == 0
                                          ? null
                                          : AppState().approverID5,
