...
void main() async {
  ...
  // Map of replacements - order matters, do longest first!
  final replacements = [
    // Colors with multi-word names first
    {
      'pattern': RegExp(
    ...
    },
    {
      'pattern': RegExp(r'FlutterFlowTheme\.of\(\s*context\s*\)\s*\.\s*success',
          multiLine: true),
      'replacement': 'Theme.of(context).colorScheme.surfaceTint',
    },
    {
    ...
    },
    {
      'pattern': RegExp(r'FlutterFlowTheme\.of\(\s*context\s*\)\s*\.\s*warning',
          multiLine: true),
      'replacement': 'Colors.orange',
    },
    {
      'pattern': RegExp(r'FlutterFlowTheme\.of\(\s*context\s*\)\s*\.\s*info',
          multiLine: true),
      'replacement': 'Theme.of(context).colorScheme.outline',
    },
    {
      'pattern':
